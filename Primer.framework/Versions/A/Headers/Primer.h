 ...
 */
- (void)registerClientWithToken:(NSString *)token;
 ...
 */
- (void)registerClientWithToken:(NSString *)token isNewInstall:(BOOL)newInstall;
...
/*!
 * @brief Gets the parameters from the install referrer. Used with the Params Dictionary Keys
 */
- (NSDictionary *)getInstallParams;

/*!
 * @brief Gets the parameters from the most recent returning referrer. Used with the Params Dictionary Keys
 */
- (NSDictionary *)getReturningParams;
